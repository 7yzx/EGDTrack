...
import sys
import argparse
envpath = '/home/whuai/mambaforge/envs/tracking_det/lib/python3.7/site-packages/cv2/qt/plugins'
...
def main():
    ...
    parser.add_argument('--tracker_param', type=str, default='', help='Name of parameter file.')
    parser.add_argument('--dataset_name', type=str, default='cdtb', help='Name of dataset (otb, nfs, uav, tpl, vot, tn, gott, gotv, lasot).')
    parser.add_argument('--input_dtype', type=str, default='color', help='[colormap, raw depth, normalized_depth, ....]')
