...
from ltr.dataset import Lasot, Got10k, TrackingNet, MSCOCOSeq,Got10k_depth, MSCOCOSeq_depth, Lasot_depth, CDTB, DepthTrack
...
def run(settings):
    ...
    # got10k_train = Got10k_depth(settings.env.got10k_dir,split='mytrain', dtype=input_dtype)
