...
parser.add_argument('--log_directory', type=str, help='directory to save checkpoints and summaries',
                    default='./mymodels_edge_grad0808')
...
parser.add_argument('--eval_summary_directory', type=str, help='output directory for eval summary,'
                    ...
                    default='./mymodels_edge_grad0808/eval/')
...
def main_worker(gpu, ngpus_per_node, args):
    ...
    dataloader = BtsDataLoader_inpaint(args, 'train')
    dataloader_eval = BtsDataLoader_inpaint(args, 'online_eval')
    ...
    # edge_criterion = edge_loss(0.9)
    edge_normal_criterion = silog_loss_grad_normal(0.8)
    ...
    while epoch < args.num_epochs:
        ...
        for step, sample_batched in enumerate(dataloader.data):
            ...
            # mask loss i seem no use
            loss_g_n = edge_normal_criterion(depth_est, depth_gt, mask.to(torch.bool))
            # 大概在3左右
            print("loss grad", loss_g_n)
            ...
            if global_step and global_step % args.log_freq == 0 and not model_just_loaded:
                ...
                if not args.multiprocessing_distributed or (args.multiprocessing_distributed
                    ...
                    writer.add_scalar('silog_grad_loss', loss_g_n, global_step)
